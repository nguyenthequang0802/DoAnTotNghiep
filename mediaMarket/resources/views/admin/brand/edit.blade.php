...
@section('content')
    <section class="dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto">
            ...
            <h2 class="my-4 text-xl font-bold text-gray-900 dark:text-white">Chỉnh sửa nhãn hiệu</h2>
