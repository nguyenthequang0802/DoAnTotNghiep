                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    ...
                    <div class="w-full p-4 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-3 dark:bg-gray-800 dark:border-gray-700 mb-4">
                        <div class="w-full">
                            ...
                            <div class="mt-4">
                                <div class="">
                                    <textarea id="content" name="info_product" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $item->info_product }}</textarea>
                                </div>
