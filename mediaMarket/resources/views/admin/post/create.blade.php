                        ...
                        <div class="">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                <div class="">
                                    ...
                                    <input type="text" id="title" name="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{ $errors->has('title') ? ' border border-red-500 placeholder-red-700' : '' }}"/>
                                    @if ($errors->has('title'))
                                ...
                                <div class="">
                                    ...
                                    <textarea id="post_seo_description" name="seo_description" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                    ...
                    <div class="w-full">
                        <div class="">
                            <div class="">
                                ...
                                <textarea id="post" name="content" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 {{ $errors->has('content') ? ' border border-red-500 placeholder-red-700' : '' }}"></textarea>
                            </div>
