                            ...
                            <div class="py-4 overflow-y-auto">
                                <ul class="space-y-2 font-medium">
                                    @foreach($global_menus as $menu)
                                        @if(count($menu->subcategory) == 0)
                                            <li>
                                                <a href="{{ route('user.store', $menu->slug) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        @else
                                            <li>
                                                ...
                                                <ul id="dropdown-menu-{{ $menu->id }}" class="hidden py-2 space-y-2">
                                                    @foreach($menu->subCategory as $sub_menu)
                                                        <li>
                                                            <a href="{{ route('user.store', $sub_menu->slug) }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ $sub_menu->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
